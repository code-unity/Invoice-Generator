          ...
          <div style={{ marginTop: -5 }}>
            ...
            >
              ...
              <div className="sidebar-content">
                ...
                <ListItem
                  button
                  onClick={() => history.push("/view-candidate")}
                >
                  <ListItemIcon style={{ marginLeft: "15px" }}>
                    <ViewComfyIcon />
                  </ListItemIcon>
          ...
          <div style={{ marginTop: -5 }}>
            ...
            >
              ...
              <div className="sidebar-content">
                ...
                <ListItem
                  button
                  onClick={() => history.push("/view-timesheet")}
                >
                  <ListItemIcon style={{ marginLeft: "15px" }}>
                    <ViewComfyIcon />
                  </ListItemIcon>
          ...
          <div style={{ marginTop: -5 }}>
            ...
            >
              ...
              <div className="sidebar-content">
                ...
                <ListItem
                  button
                  onClick={() => history.push("/invoice-filter")}
                >
                  <ListItemIcon style={{ marginLeft: "15px" }}>
